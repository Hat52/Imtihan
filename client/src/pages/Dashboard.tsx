...
export default function Dashboard() {
	return (
		<div className="dashboard">
			<Navbar />
			<div className="flex flex-col w-screen p-5 pt-20 md:p-20 md:flex-row md:gap-20 h-screen">
				<InformationCard />
				<hr className="md:invisible border border-dark-grey my-10 " />
				<div className="w-full md:p-5  md:w-4/5 flex flex-col gap-5 h-full">
					...
					<div className="w-full py-5 md:py-10 h-full flex gap-5 flex-wrap">
...
const InformationCard = () => {
	return (
		<div className="w-5/5 gap-3 flex items-center px-10 flex-col md:w-1/5   shadow-dark-grey shadow-md border border-dark-grey  py-10 h-max rounded-[2px] text-typography">
